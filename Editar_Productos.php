...
<body onmousemove="closesubnav(event);"><div class="skipLinks">skip to: <a href="#content">page content</a> | <a href="#pageNav">links on this page</a> | <a href="#globalNav">site navigation</a> | <a href="#siteInfo">footer (site information)</a> </div><div id="masthead"><h1 id="siteName"><?php if($_SESSION['nickk'] != ""){echo "".$_SESSION['nickk'];}else{echo " Jacky's Salon ";}?></h1><div id="utility"> <a href="login.php">Entrar</a> | <a href="salir.php">Salir</a> | <a href="R.php">Registrate</a> </div><div id="globalNav"> <img alt="" src="gblnav_left.gif" height="32" width="4" id="gnl" /> <img alt="" src="glbnav_right.gif" height="32" width="4" id="gnr" /><div id="globalLink"><a href="#"id="gl1"class="glink"onmouseover="ehandler(event,menuitem1);">Siguenos</a><a href="#" id="gl2"class="glink" onmouseover="ehandler(event,menuitem2);"></a><a href="#" id="gl3" class="glink"onmouseover="ehandler(event,menuitem3);"></a><a href="#" id="gl4" class="glink" onmouseover="ehandler(event,menuitem4);"></a><a href="#" id="gl5" class="glink" onmouseover="ehandler(event,menuitem5);"></a><a href="#" id="gl6" class="glink" onmouseover="ehandler(event,menuitem6);"></a><a href="#" id="gl7" class="glink" onmouseover="ehandler(event,menuitem7);"></a> </div></div><div id="subglobal1" class="subglobalNav"> <a href="#">Faceook</a> | <a href="#">Twitter</a> | <a href="#">5paces</a></div><div id="subglobal2" class="subglobalNav"></div><div id="subglobal3" class="subglobalNav"></div><div id="subglobal4" class="subglobalNav"></div><div id="subglobal5" class="subglobalNav"></div><div id="subglobal6" class="subglobalNav"></div><div id="subglobal7" class="subglobalNav"></div><div id="subglobal8" class="subglobalNav"></div></div><div id="pagecell1"><img alt="" src="tl_curve_white.gif" height="6" width="6" id="tl" /><img alt="" src="tr_curve_white.gif" height="6" width="6" id="tr" /><div id="breadCrumb"></div><div id="pageName"><h2> Jacky's Salon</h2><img alt="small logo" src="" height="59" width="66"/> </div><div id="pageNav"><div id="sectionLinks"><a href="menu.php">Menu</a><a href="servicios.php">Servicios</a><a href="e.php">Productos</a><a href="#">Sitar</a><a href="#">Chat</a><a href="#">Contactanos</a></div><div class="relatedLinks"><h3>Anuncios</h3><a href="#">Producto</a><a href="#">Facebook</a><a href="#">Twitter</a><a href="#">Related Link</a></div><div class="relatedLinks"><h3><img src="" alt="" width="107" height="66" /> </h3>
      <h3>Luce tu belleza en Jacky’s Salón </h3>
</div></div><div id="content"><div class="feature"><?php ;echo " la SEchoON es ".$_SESSION['nickk'];?>
<h3>Productos </h3><img src="bg_nav.jpg" />
...
<input type="submit" name="enviar2" value="ver"> 
  ...
  <form action="EditarPcphp.php" method="post" class="registro">
...
?> 
Descripcion:
  <input type="text"  style="WIDTH: 700px; HEIGHT: 30px" 
size=32 name="Descripcion" value="<?php echo "".$descripcion ?>"  />
  <div>
  Precio:
  <input type="text"  style="WIDTH: 50px; HEIGHT: 30px" 
size=32 name="precio" value="<?php echo "".$Precio ?>"  />
  <div>
  Dias de espera:
  <input type="text"  style="WIDTH: 50px; HEIGHT: 30px" 
size=32 name="Dias" value="<?php echo "".$dias ?>"  />
  <div>
  <label>
  <div>
