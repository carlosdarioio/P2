...
<div id="pagecell1"><!--pagecell1-->
  ...
  <div id="pageNav">
    ...
    <div class="relatedLinks">
      <h3><img src="logo2.jpg" alt="" width="107" height="66" /> </h3>
...
$registros=mysql_query("select nick from usuario where nick='$_REQUEST[nick]'",$conexion) or
  ...
  #
   if($n != $_REQUEST[nick]){
$registros=mysql_query("insert into usuario(nick,nombre,apellido,email,contra,telefono,tipo) values ('$_REQUEST[nick]','$_REQUEST[nombre]','$_REQUEST[apellido]','$_REQUEST[email]','$_REQUEST[contra]','$_REQUEST[telefono]','Cliente')",$conexion) or
  die("Problemas en el select1:".mysql_error());
...
?>
    ...
    <form action="Registrate_C.php" method="post" class="registro">
<div><label>Ingrese nombre de usuario(nick):</label><input type="text" name="nick" ></div>
<div><label>ingrese contraseña:</label><input type="password" name="contra"></div>
